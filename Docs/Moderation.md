...
`moderation.py` is the most important file in the project and it all the moderation features like:
- report user
- warn user
- mute user
- kick user
...
we have moderation class and all the functions inside the class
```py
